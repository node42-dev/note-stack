...
<style>
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .mention, a.mention, a.mention:link, a.mention:visited { color: #9B6B9C; background: rgba(188,143,189,0.12); border-radius: 3px; padding: 0 3px; cursor: pointer; font-weight: 500; text-decoration: none; }
  .mention:hover,a.mention:hover { background: rgba(188,143,189,0.22); text-decoration: none; }
